...
public class ImageUtils {
	...
	public static final String TYPE_UNKNOWN = ".jpg";
	...
	public static String getTypeByContentType(String contentType) {
		...
		switch (str[1]) {
		case "png":
			type = ImageUtils.TYPE_PNG;
			break;
		case "gif":
			type = ImageUtils.TYPE_GIF;
			break;
		case "jpg":
			type = ImageUtils.TYPE_JPG;
			break;
		case "jpeg":
			type = ImageUtils.TYPE_JPG;
			break;
		case "ico":
			type = ImageUtils.TYPE_ICO;
			break;
		default:
			type = ImageUtils.TYPE_UNKNOWN;
			break;
		}
		return type;
	}
